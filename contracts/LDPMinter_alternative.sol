...
/**
 * @title Lucky Duck Pack Minter (Dutch auction)
 *
...
contract LDPMinter is Ownable, ReentrancyGuard {
    ...
    uint256 private constant _START_PRICE = 3 ether; // Initial price when the Dutch auction begins
    uint256 private constant _END_PRICE = 0.01 ether; // Minimum price at the end of the Dutch Auction
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        unchecked {
            // Calculate price
            price = _currentPrice_t6y() * amount;
    ...
    function withdrawProceeds() external {
        ...
        // Actual withdraw
        (bool creatorPaid, bool rewarderPaid) = _processWithdraw_ama();
    ...
    function emergencyWithdraw() external onlyOwner {
        ...
        require(NFT.totalSupply() == NFT.MAX_SUPPLY(), "Minting still in progress");
