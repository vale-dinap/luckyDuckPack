...
contract LDPLuckyDraw_TESTNET is
    Ownable,        // Admin role
    VRFConsumerBase // Chainlink Random
{
    ...
    // LINK token contract
    address private constant _LINKTOKEN = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB;
    // Chainlink VRF contract
    address private constant _VRFCOORDINATOR = 0x2bce784e69d2Ff36c71edcB9F88358dB0DfB55b4;
    // 2 LINK fee on Ethereum Mainnet
    uint256 private constant _CHAINLINKFEE = 0.1 ether; // 0.1 LINK fee on Goerli Testnet
    // Key hash required by Chainlink VRF
    bytes32 private constant _CHAINLINKKEYHASH = 0x0476f9a745b61ea5c0ab224d3a6e4c99f0b02fce4da01143a4f70aa80ae76e8a;
